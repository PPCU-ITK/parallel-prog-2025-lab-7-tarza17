...
int main(){
    ...
    #pragma omp target teams distribute parallel for collapse(2) map(to:cx,cy,radius) map(tofrom:rho[0:total_size],rhou[0:total_size],rhov[0:total_size],E[0:total_size],solid[0:total_size])
    ...
    #pragma omp target data map(to:Nx,Ny,rho0,u0,v0,E0,dt,dx,dy,total_size,solid[0:total_size]) map(tofrom:rho[0:total_size],rhou[0:total_size],rhov[0:total_size],E[0:total_size],rho_new[0:total_size],rhou_new[0:total_size],rhov_new[0:total_size],E_new[0:total_size])
